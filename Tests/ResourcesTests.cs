...
namespace Tests
{
	public class ResourcesTests
	{
		...
		public void CanSubtract_should_be_false(ulong metal, ulong crystal, ulong deuterium, ulong otherMetal,
			ulong otherCrystal, ulong otherDeuterium)
		{
			// Setup
		...
		public void CanSubtract_should_be_true(ulong metal, ulong crystal, ulong deuterium, ulong otherMetal,
			ulong otherCrystal, ulong otherDeuterium)
		{
			// Setup
			var subject = new Resources(metal, crystal, deuterium);
