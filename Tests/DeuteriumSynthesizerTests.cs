...
namespace Tests
{
	public class DeuteriumSynthesizerTests
	{
		...
		public void Deuterium_synthesizer_should_produce_deuterium(uint level, ulong expectedProduction,
			int temperature)
		{
			// Setup
		...
		public void Deuterium_synthesizer_upgrade_should_cost(uint level, ulong metal, ulong crystal, ulong deuterium)
		{
			// Setup
			var state = new GameState { AreResourcesFrozen = true };
